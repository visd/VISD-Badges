...
BASE_APP_ROOT = path.join(PROJECT_ROOT, 'badges')
# DJANGO_ROOT = path.dirname(path.realpath(django.__file__))
...
MEDIA_ROOT = path.join(BASE_APP_ROOT,'media')
...
STATIC_ROOT = path.join(BASE_APP_ROOT,'static')
...
MIDDLEWARE_CLASSES = (
    ...
    'custom.middleware.HttpMethodsMiddleware'
...
TEMPLATE_DIRS = (
    path.join(BASE_APP_ROOT,'templates')
