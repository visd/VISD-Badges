...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'badges_challenge', 'title', self.gf('django.db.models.fields.CharField')(unique=True, max_length=90))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Challenge.title'
        db.alter_column(u'badges_challenge', 'title', self.gf('django.db.models.fields.CharField')(max_length=60, unique=True))

        # Changing field 'Resource.title'
        db.alter_column(u'badges_resource', 'title', self.gf('django.db.models.fields.CharField')(max_length=60))

        # Changing field 'Entry.title'
        db.alter_column(u'badges_entry', 'title', self.gf('django.db.models.fields.CharField')(max_length=60))
    ...
    models = {
        u'badges.challenge': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '90', 'db_index': 'True'}),
